...
if (!isset($_REQUEST['bAceptar'])) {
    ...
    if (empty($errores)) {
        ...
        $serializedGeneros = serialize($genero);

        header("location:correcto.php?titulo=$titulo&fechaEstreno=$fechaEstreno&duracion=$duracion&genero=$serializedGeneros&pais=$pais&sinopsis=$sinopsis&fotoCartel=$dirFotoCartel&fotoReparto_1=$dirFotoReparto_1&fotoReparto_2=$dirFotoReparto_2");
    } else {
